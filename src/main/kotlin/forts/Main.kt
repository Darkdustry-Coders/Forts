...
class Main: Plugin() {
    override fun init() {
        ...
        (Blocks.titan as ItemTurret).ammoTypes.get(Items.thorium).buildingDamageMultiplier = 0.1f
        (Blocks.titan as ItemTurret).ammoTypes.get(Items.thorium).splashDamage = 350f
